...
/**
 * Рівні важливості (критичності) повідомлень та подій.
 * Використовується для візуального кодування статусів у системі.
 */
export enum LevelStatusType {
  /** Успішне завершення операції (зелений) */
  SUCCESS = 'success',

  /** Інформаційне повідомлення або системна зміна (блакитний) */
  INFO = 'info',

  /** Попередження про потенційну проблему або видалення (жовтий/помаранчевий) */
  WARN = 'warn',

  /** Помилка виконання або критична подія (червоний) */
  ERROR = 'error',

  /** Допоміжна або нейтральна інформація (сірий) */
  SECONDARY = 'secondary'
}

registerEnumType(LevelStatusType, {
  name: 'LevelStatusType',
  description: 'Рівні важливості системних повідомлень'
});
